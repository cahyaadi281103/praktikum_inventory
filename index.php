...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fontsource/source
sans-3@5.0.12/index.css" 
    ...
    <div class="login-container"> 
        <div class="card card-primary card-outline mb-4"> 
            ...
            <img src="assets/img/gambar1.png" width="80" height="80" alt="icon"> 
                <h3 class="card-title float-none">KOPI KITA</h3> 
            </div> 
            <form action="login.php" method="post"> 
                <div class="card-body"> 
                    <div class="mb-3"> 
                        <label for="username" class="form-label">Cahya Adi Saputra</label> 
